...
const galeriData: GaleriItem[] = [
    ...
    { id: 16, cat: 'padel', tall: true, title: 'Padel Indoor Yogyakarta', kota: 'Yogyakarta', material: 'Kaca Tempered + Artificial Grass', desc: 'Lapangan padel indoor pertama di Yogyakarta. Desain estetik dengan lighting warna-warni.', badge: '🎾 Padel', badgeColor: 'text-orange-700 bg-orange-50 border-orange-200', ph: '📸 FOTO PADEL 5\nPencahayaan Malam / Aesthetic Shot\n(700×500px)' },
    // BADMINTON
...
<template>
            ...
            <div class="lb-wrap">
                ...
                <div class="lb-info">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <span :class="['text-xs font-bold px-2.5 py-1 rounded-full border inline-block mb-2', lightboxItem?.badgeColor]">
                                {{ lightboxItem?.badge }}
                            </span>
                            <h3 class="font-display font-black text-lg text-stone-900">{{ lightboxItem?.title }}</h3>
                            <p class="text-sm text-stone-500 mt-1">{{ lightboxItem?.desc }} | 📍 {{ lightboxItem?.kota }} | 🧱 {{ lightboxItem?.material }}</p>
                        </div>
    ...
    <section class="pt-28 pb-10 px-6 max-w-6xl mx-auto">
        <div class="reveal">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <span class="inline-block bg-green-100 text-[#006400] text-xs font-bold px-3 py-1.5 rounded-full mb-3 tracking-wide">📸 Portofolio Nyata</span>
    ...
    <section class="py-16 px-6 bg-[#006400]">
        <div class="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div>
                <h2 class="font-display font-black text-2xl md:text-3xl text-white mb-2">Tertarik Punya Lapangan Seperti Ini?</h2>
