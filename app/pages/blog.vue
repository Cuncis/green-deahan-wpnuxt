    ...
    <section class="py-16 px-6 bg-[#006400]">
        <div
            ...
            <a href="https://wa.me/6281357570064?text=Halo,%20saya%20ingin%20konsultasi%20lapangan%20setelah%20baca%20blog"
                ...
                class="inline-flex items-center gap-2 flex-shrink-0 bg-white text-[#006400] font-bold px-7 py-3.5 rounded-xl hover:bg-green-50 transition-colors text-sm whitespace-nowrap shadow-lg">
