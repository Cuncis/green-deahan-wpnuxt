            ...
            <div class="lg:col-span-2 space-y-5 reveal">
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-6">
                    ...
                    <div class="mt-5 pt-4 border-t border-stone-100">
                        <p class="text-xs font-bold text-stone-400 uppercase tracking-wide mb-3">Ikuti Kami</p>
                        <div class="flex gap-2">
                            <a href="https://www.instagram.com/green_deahan1927" target="_blank"
                                rel="noopener noreferrer" aria-label="Instagram"
                                class="w-8 h-8 rounded-lg flex items-center justify-center bg-stone-100 hover:bg-pink-600 hover:text-white transition-colors text-stone-500">
                            ...
                            <a href="https://www.facebook.com/greendeahan/" target="_blank" rel="noopener noreferrer"
                                aria-label="Facebook"
                                class="w-8 h-8 rounded-lg flex items-center justify-center bg-stone-100 hover:bg-[#1877f2] hover:text-white transition-colors text-stone-500">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                                    <path
                                        d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                            </a>
                            <a href="https://www.tiktok.com/@green_deahan" target="_blank" rel="noopener noreferrer"
                                aria-label="TikTok"
                                class="w-8 h-8 rounded-lg flex items-center justify-center bg-stone-100 hover:bg-stone-800 hover:text-white transition-colors text-stone-500">
                            ...
                            <a href="https://x.com/greendeahan1927" target="_blank" rel="noopener noreferrer"
                            ...
                            <a href="https://www.youtube.com/@green_deahan" target="_blank" rel="noopener noreferrer"
                                aria-label="YouTube"
                                class="w-8 h-8 rounded-lg flex items-center justify-center bg-stone-100 hover:bg-red-600 hover:text-white transition-colors text-stone-500">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                                    <path
